/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35c8947a33ee86fc745f1c1c3ab01f16)
// Runtime types generated with workerd@1.20250712.0 2025-04-25 
declare namespace Cloudflare {
	interface Env {
		SwarmFM_LiveStatusKV: KVNamespace;
		WEBHOOK_SECRET: string;
		VERIFY_TOKEN: string;
		UPDATE_SECRET: string;
		YT_API_KEY: string;
		PSHB_LEASE_SECONDS: string;
		ENABLE_SCHEDULED: string;
		LIVE_DO: DurableObjectNamespace /* LiveStatusDO */;
	}
}
